...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.addTodo = function () { };
...
var TodoControllerComponent = /** @class */ (function () {
    function TodoControllerComponent(todoService) {
        this.todoService = todoService;
        this.taskText = "";
    }
    TodoControllerComponent.prototype.ngOnInit = function () { };
    TodoControllerComponent.prototype.addTask = function () {
        this.todoService.addTask(this.taskText);
        this.taskText = "";
    };
    // calling addTask when user press the enter in a input form.
    TodoControllerComponent.prototype.onKeydown = function (event) {
        event.key === "Enter" ? this.addTask() : null;
    };
    TodoControllerComponent.prototype.clearTasks = function () {
        this.todoService.clearTasks();
    };
    TodoControllerComponent.prototype.removeTask = function () {
        this.todoService.removeTasks();
    };
    TodoControllerComponent.ctorParameters = function () { return [
    ...
    return TodoControllerComponent;
}());
...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.addTask = function (text) {
        var task = new _models_task_task__WEBPACK_IMPORTED_MODULE_2__["Task"](this.nextId, text);
    ...
    TodoService.prototype.removeTasks = function () {
        this.tasks.splice(0, 1);
        this.nextId = this.tasks.length;
        this.saveInLocalStorage(this.tasks);
    };
    //deletes all tasks
    TodoService.prototype.clearTasks = function () {
        this.tasks = [];
        this.nextId = 0;
        window.localStorage.removeItem(this.localKey);
    };
    TodoService.prototype.saveInLocalStorage = function (tasks) {
